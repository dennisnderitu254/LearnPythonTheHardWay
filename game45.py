...
# Debug this sample game

# File "game45.py", line 262, in <module>  a_game.play()

# File "game45.py", line 59, in play next_scene_name = current_scene.enter()

# File "game45.py", line 76, in enter
    # print Death.quips[randint(0, len(self.quips)-1)]
