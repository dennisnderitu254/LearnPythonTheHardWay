...
print "Is it greater?" , 5.4 > 8.90

# test if 5 is greater or equal to -2
print "Is it greater or equal?" , 5 >= 10.20

# test if 5 is less than or equal to -2
print "Is it less or equal?" , 5.25 <= -2.0